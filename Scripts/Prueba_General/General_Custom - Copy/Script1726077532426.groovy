...
WebUI.setText(findTestObject('Page_OzaruOne/input_WhatsApp_whatsapp'), '3525006338')
...
WebUI.setText(findTestObject('Page_OzaruOne/input_WhatsApp_whatsapp'), '3315206338')
...
WebUI.click(findTestObject('Messages/test_button'))
...
WebUI.click(findTestObject('Messages/span_image'))
